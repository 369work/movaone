...
<div class="wrap">
	...
	<div class="content">
		...
		<p><?php esc_html_e( 'To get started with the Movaone theme, you can customize the theme using the Customizer.', 'movaone' ); ?>
		</p>
		<a href="<?php echo esc_url( admin_url( 'customize.php?movaone-theme-options' ) ); ?>"
			style="display: inline-block; margin: 1rem 0; padding: 10px 20px; background-color: #0073aa; color: #fff; text-decoration: none; border-radius: 5px; text-align: center;"><?php esc_html_e( 'Customize', 'movaone' ); ?></a>

	</div>

	<div class="content">
		<h3 class="admin-sub-title"><?php esc_html_e( 'Basic usage of Movaone theme', 'movaone' ); ?></h3>
		<p><?php esc_html_e( 'Editing the left content section for PC display is done from the "Left Panel Content" page.', 'movaone' ); ?>
		</p>
		<p><?php esc_html_e( 'The Customizer allows you to easily customize the look of your site. You can customize the following elements:', 'movaone' ); ?>
		</p>
		<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">

			<div
				style="border: 1px solid #94a3b8; padding: 10px; margin-bottom: 10px; border-radius: 5px; background-color: #f0f9ff;">
		...
		<a href="<?php echo esc_url( admin_url( 'customize.php?movaone-theme-options' ) ); ?>"
			style="display: inline-block; margin: 1rem 0; padding: 10px 20px; background-color: #0073aa; color: #fff; text-decoration: none; border-radius: 5px; text-align: center;">
	...
	<div class="content">
		...
		<p><?php esc_html_e( 'If you have any questions or need help with the movaone theme, please visit the support page.', 'movaone' ); ?>
		</p>
		<a href="https://369theme.com/products/movaone" target="_blank"
			style="display: inline-block; margin: 1rem 0; padding: 10px 20px; background-color: #0073aa; color: #fff; text-decoration: none; border-radius: 5px; text-align: center;"><?php esc_html_e( 'Go Details Page', 'movaone' ); ?></a>
	</div>
	...
	<div class="content">
		...
		<p><?php esc_html_e( 'We would love to hear your feedback on the Movaone theme. Please take a moment to leave a review.', 'movaone' ); ?>
		</p>
		<a href="https://wordpress.org/support/theme/movaone/reviews/" target="_blank"
			style="display: inline-block; margin: 1rem 0; padding: 10px 20px; background-color: #0073aa; color: #fff; text-decoration: none; border-radius: 5px; text-align: center;">
