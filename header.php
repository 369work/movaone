		...
		<header>
			<div class="container">
				<div class="header__wrap">
					<a class="skip-link" href="#main"><?php esc_html_e( 'Skip to content', 'movaone' ); ?></a>
					...
					<div class="header__nav">
						<div class="header__link">
							<a href="<?php echo esc_url( movaone_cta_link() ); ?>"
				...
				<div id="header-menu-modal" class="header__menu" aria-modal="true" aria-label="header-menu"
					aria-hidden="true">
			...
			<aside>
				<div class="aside__wrap">
					<div class="aside__title">
						...
						if ( $page_id ) {
							echo wp_kses_post( apply_filters( 'the_content', $page_id->post_content ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						}
						?>
					</div>
				</div>
